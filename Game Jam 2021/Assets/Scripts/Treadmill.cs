...
public class Treadmill : MonoBehaviour
{
    ...
    void PrintShoeprint()
    {
        if (Input.GetMouseButtonDown(0))
        {
            ...
            if (hitCollider != null && hitCollider.CompareTag("ball") && cnt == 0)
            {
                Debug.Log("hit");
            ...
            else if (hitCollider != null && hitCollider.CompareTag("ball") && cnt == 1)
            {
                Debug.Log("hit");
                Destroy(GameObject.FindWithTag("ball"));
            ...
            else if (hitCollider != null && hitCollider.CompareTag("ball") && cnt == 2)
            {
                Debug.Log("hit");
                Destroy(GameObject.FindWithTag("ball"));
